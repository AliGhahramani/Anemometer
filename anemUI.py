...
readings = {}  # {anemometer_id : Reading}
...
room_anemometer_ids = []
all_anemometer_ids = []
executable_path = "./anemomteer-master.exe"


# Reads in input line by line, parses it, and saves it to next_reading
def read_input():
    ...
    while True:
        ...
        if path_string not in readings[anemometer_id].path_readings:
            datetime_str = words[0] + ' ' + words[1][0:-3] + ' ' + words[2] 
